...
void GL_VertexBuffer::CreateBuffer(std::vector<core::Vertex> &vertices, std::vector<uint32_t> &indices)
{
	...
	// color attribute
	glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, sizeof(core::Vertex), (void*)(sizeof(glm::vec3)));
	glEnableVertexAttribArray(1);
	// texture coord attribute
	glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, sizeof(core::Vertex), (void*)(2*sizeof(glm::vec3)));
